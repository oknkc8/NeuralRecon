...
class RayCastRGBDFunction(Function):
    @staticmethod
    def forward(ctx, locs, vals_sdf, vals_colors, vals_normals, view_matrix_inv, intrinsic_params, dims3d, width, height, depth_min, depth_max, thresh_sample_dist, ray_increment, image_color, image_depth, image_normal, sparse_mapping, mapping3dto2d, mapping3dto2d_num, d_color, d_depth, d_normal, origin, voxel_size):
        ...
        opts = torch.FloatTensor([width, height, depth_min, depth_max, thresh_sample_dist, ray_increment, dims3d[2], dims3d[1], dims3d[0], voxel_size])
        ...
        raycast_rgbd_cuda.forward(sparse_mapping.to(vals_sdf.device), locs.to(vals_sdf.device), vals_sdf, vals_colors, vals_normals, view_matrix_inv, image_color, image_depth, image_normal, mapping3dto2d, mapping3dto2d_num, intrinsic_params, origin, opts)
    ...
    def backward(ctx, grad_color, grad_depth, grad_normal):
        ...
        return None, d_depth[:dims[4]], d_color[:dims[4]], d_normal[:dims[4]], None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None
