...
_C.TRAIN.APPLY_LOSS = 20
_C.TRAIN.APPLY_GRU = 20
_C.TRAIN.SAMPLING = True
...
_C.MODEL.LW = [1.0, 0.8, 0.64, 1.0, 1.0]
...
_C.MODEL.PROJECTION.LOSS = False
_C.MODEL.PROJECTION.LOSS_WEIGHT = 1
_C.MODEL.PROJECTION.THRESHOLD = 0.5
_C.MODEL.PROJECTION.UPSCALE = 10

_C.MODEL.FOV_TSDF_LOSS = CN()
_C.MODEL.FOV_TSDF_LOSS.LOSS = False
_C.MODEL.FOV_TSDF_LOSS.WEIGHT = 1
_C.MODEL.FOV_TSDF_LOSS.DEPTH_INDEX_MAX = 192

_C.MODEL.RERENDER = CN()
_C.MODEL.RERENDER.LOSS = False
_C.MODEL.RERENDER.NORMAL = False
_C.MODEL.RERENDER.WEIGHT = 1
_C.MODEL.RERENDER.MAX_NUM_POINTS = 4000000
_C.MODEL.RERENDER.RAYCAST_DEPTH_MAX = 3

_C.MODEL.AUGMENTATION = CN()
_C.MODEL.AUGMENTATION.AUGMENTATION_ON = False
_C.MODEL.AUGMENTATION.KEYFRAME_RATIO = 2
_C.MODEL.AUGMENTATION.WEIGHT = 1
_C.MODEL.AUGMENTATION.LOSS_RATIO = 1
